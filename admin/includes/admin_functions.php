...
function createTopic($request_values){
    ...
    // Get ID
    $topic_id_query = "SELECT TOP 1 * FROM topics ORDER BY id DESC";
    $result_topic_id = mysqli_query($conn, $topic_id_query);
    var_dump($result_topic_id);
    $topic_id = $result_topic_id['id']+1;
